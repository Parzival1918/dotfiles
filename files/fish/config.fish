...
{%@@ elif devicename == "ubuntu" @@%}
set PATH $PATH /home/linuxbrew/.linuxbrew/bin /home/linuxbrew/.linuxbrew/sbin /home/unstraycato/programs/ovito-basic-3.9.4-x86_64/bin /home/unstraycato/programs/julia-1.9.4/bin /home/unstraycato/programs/travis-src-220729/exe /home/unstraycato/.config/emacs/bin /home/unstraycato/.cargo/bin /home/unstraycato/.local/bin /usr/local/sbin /usr/local/bin /usr/sbin /usr/bin /sbin /bin /usr/games /usr/local/games /snap/bin /snap/bin /home/unstraycato/.local/share/bob/nvim-bin
{%@@ endif @@%}
